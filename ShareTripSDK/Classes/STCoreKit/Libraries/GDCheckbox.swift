...
public class GDCheckbox: UIControl {
    ...
    @IBInspectable
    open var containerCornerRadius: CGFloat = 3.0{
        didSet{
            drawLayers()
        }
    }
    ...
    @IBInspectable
    open var containerFillColor: UIColor = UIColor.black{
        didSet{
            drawColors()
        }
    }
    ...
    fileprivate var containerPath: UIBezierPath{
        if isRadiobox || isCircular{
            ...
            return UIBezierPath(roundedRect: containerFrame, cornerRadius: containerCornerRadius)
        }
    }
    ...
    fileprivate func drawLayers(){
        ...
        containerLayer.cornerRadius = 3.0
    ...
    fileprivate func drawColors(){
        DispatchQueue.main.async {
            ...
            if self.isOn {
                self.containerLayer.strokeColor = self.containerFillColor.cgColor
                self.containerLayer.fillColor = self.shouldFillContainer ? self.containerFillColor.cgColor : UIColor.clear.cgColor
