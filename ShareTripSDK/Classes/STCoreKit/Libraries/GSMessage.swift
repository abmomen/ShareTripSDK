...
extension UIViewController {
    ...
    public func showMessage(_ text: String,
                          type: GSMessageType,
                          options: [GSMessageOption]? = [.autoHide(true), .hideOnTap(true), .autoHideDelay(2)]) {
...
public class GSMessage: NSObject {
    ...
    public static var successBackgroundColor : UIColor = UIColor(red: 0.26, green: 0.63, blue: 0.27, alpha: 0.95)
    public static var warningBackgroundColor : UIColor = UIColor(red: 0.98, green: 0.66, blue: 0.15, alpha: 0.95)
    public static var errorBackgroundColor   : UIColor = UIColor(red: 1.00, green: 0.20, blue: 0.15, alpha: 0.90)
    public static var infoBackgroundColor    : UIColor = UIColor(red: 0.00, green: 0.77, blue: 0.96, alpha: 0.90)
    ...
    public private(set) var autoHideDelay: Double = 4
    ...
    public private(set) var padding: UIEdgeInsets = .init(top: 8, left: 16, bottom: 8, right: 16)
    ...
    @objc fileprivate func updateFrames() {
        ...
        if let attrText = messageText.attributedText {
            let size = CGSize(width: 2*textWidth/3, height: 999)
