...
public enum DateFormatType: CaseIterable {
    ...
    /// The ISO8601 formatted date, time and millisec "yyyy-MM-dd'T'HH:mm:ss.SSS" i.e. 1997-07-16T19:20:30.45+01:00
    ...
    public var stringFormat:String {
        ...
        case .isoDateWithSlash: return  "yyyy/MM/dd"
        ...
        case .shortDateWithdatequote: return "dd''MMM yy"
        case .shortDateFullYear: return "dd MMM yyyy"
        case .custom(let customFormat): return customFormat
        case .isoDateTimeWithoutOffset: return "yyyy-MM-dd'T'HH:mm:ss"
        case .isoDateCustomTimeMilliSec: return "yyyy-MM-dd'T'HH:mm:ss.sss"
        case .timeIn12Hr: return "hh:mm a"
        }
    }
}
